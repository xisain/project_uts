<div class="flex">
    <div class="w-64 bg-white min-h-screen shadow-2xl">
        <!-- Add your sidebar links here -->
        <div class="py-4 px-6">
        </div>
        <ul class="space-y-4">
            <li>
                <a href="./barang/" class="flex items-center space-x-4 text-2xl font-semibold text-gray-900 hover:bg-gray-200 rounded-lg">
            ...
            <li>
                <a href="./customer/view.php" class="flex items-center space-x-4 text-2xl font-semibold text-gray-900 hover:bg-gray-200 rounded-lg">
                    <span class="text-xl text-gray-500">
            ...
            <li>
                <a href="./user/view.php" class="flex items-center space-x-4 text-2xl font-semibold text-gray-900 hover:bg-gray-200 rounded-lg">
                    <span class="text-xl text-gray-500">
                        <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5 21C5 17.134 8.13401 14 12 14C15.866 14 19 17.134 19 21M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
            ...
            <li>
                <a href="sales.php" class="flex items-center space-x-4 text-2xl font-semibold text-gray-900 hover:bg-gray-200 rounded-lg">
                    <span class="text-xl text-gray-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" height="25px" width="25px" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 296.41 296.41" enable-background="new 0 0 296.41 296.41">
                            <g>
