...
<body class="bg-gray-100 p-8">
    ...
    <h3 class="text-2xl font-bold mb-4">Form Import Data</h3>

    <form method="post" action="form.php" enctype="multipart/form-data" class="mb-8">
        <a href="Format.xlsx" class="text-blue-500 hover:underline">Download Format</a>
        &nbsp;|&nbsp;
        <a href="index.php" class="text-blue-500 hover:underline">Kembali</a>
        <br><br>

        <input type="file" name="file" class="mb-4 p-2 border rounded">
        <button type="submit" name="preview" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700">
            Preview
        </button>
    </form>
        ...
        if ($ext == "xlsx") {
            ...
            foreach ($sheet as $row) { // Lakukan perulangan dari data yang ada di excel
                ...
                if ($numrow > 1) {
                    ...
                    if ( $nama == "" or $jenis_kelamin == "" or $telp == "" or $alamat == "" or $price == "") {
